...
export const FORMATIONS: Formation[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "cm1", label: "MC",  positionKeys: ["MC","ME-D"],         x: 0.65, y: 0.57 },
      { id: "cm2", label: "MC",  positionKeys: ["MC"],                x: 0.50, y: 0.57 },
      { id: "cm3", label: "MC",  positionKeys: ["MC","ME-I"],         x: 0.35, y: 0.57 },
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "cm1", label: "MC",  positionKeys: ["MC","ME-D"],       x: 0.68, y: 0.50 },
      { id: "cm2", label: "MC",  positionKeys: ["MC","ME-I"],       x: 0.32, y: 0.50 },
